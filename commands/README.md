...
| `.palate/explore/seed/` | the canvas working files: one artboard per board, its images, `canvas.json` | the design skill, when it seeds the canvas | no, regenerated by `boards-render.mjs` |
