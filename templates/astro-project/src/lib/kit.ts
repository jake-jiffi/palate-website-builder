  ...
  },
  {
    ...
    variations: [
      ...
      { id: "HeroCentredPreview", name: "Centred headline with product preview",
        when: "A product: a short centred headline over the real interface at full fidelity, never a stylised render; a pair of actions only when there are genuinely two paths.",
      ...
      { id: "HeroServicePhoto", name: "Service hero with real photography",
        when: "Photography that is the brand: the image full-bleed, the headline inside it, one action and nothing else on it.",
        needs: ["headline", "lede", "call to action", "a full-bleed photograph at 1600px or wider"],
        states: ["hover", "focus", "long"], ownsPageHeading: true, evidence: ["aesop", "warby-parker", "lanserring", "mejuri", "barrys"] },
    ],
  },
  {
    ...
    variations: [
      ...
      { id: "TrustRatings", name: "Review ratings",
        ...
        states: ["empty"], evidence: ["habito", "lovevery", "warby-parker"] },
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "ProblemSideBySide", name: "Side-by-side comparison",
        when: "The buyer's current experience against yours, named right after trust and before any feature.",
        needs: ["3-6 paired statements", "a label for each column"],
        states: ["long", "empty"], evidence: ["pilot-accounting", "parsley-health", "plausible"] },
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "DemoEntryPoint", name: "Interactive demo entry point",
        when: "The product's own first step offered directly, one card per genuine path, with what it costs to try stated.",
  ...
  },
  {
    ...
    variations: [
      { id: "ProcessThreeStep", name: "Three-step process",
        when: "Three numbered steps with a badge each, for any service where the sequence is the reassurance.",
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "PricingTable", name: "Comparison table",
        when: "Plans side by side when the differences are what is included rather than the price.",
        needs: ["2-5 plans", "6-20 attributes with a value per plan"],
        states: ["hover", "focus", "long", "empty"], evidence: ["parsley-health", "wealthsimple", "posthog"] },
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "CompareBeforeAfter", name: "Current approach versus improved approach",
        when: "The current approach against yours as paired statements; the relief argument in table form.",
        needs: ["4-8 paired statements", "a label for each column"],
        states: ["long", "empty"], evidence: ["re-bath", "wealthsimple"] },
    ],
  },
  {
    id: "faq", name: "FAQs",
    ...
    variations: [
      ...
      { id: "FaqAccordion", name: "Expandable questions",
        ...
        states: ["open", "hover", "focus", "long", "empty"], evidence: ["parsley-health", "lava-dental", "unoit", "habito"] },
    ],
  },
  {
    id: "cta", name: "CTA sections",
    when: "One closing action that echoes the hero's, only after the evidence; a one-line banner mid-page for the reader already convinced.",
    ...
    variations: [
      { id: "CtaBanner", name: "Compact banner",
        ...
        states: ["hover", "focus", "long"], evidence: ["swillhouse", "block-renovation", "crisp"] },
