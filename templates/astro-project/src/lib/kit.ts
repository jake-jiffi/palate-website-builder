  ...
  },
  {
    ...
    variations: [
      ...
      { id: "PricingTable", name: "Comparison table",
        when: "Several priced tiers whose differences are their inclusions. The library presents tiers as product cards with one recommended, so reach for the table only when the inclusions run longer than a card can carry.",
