...
The `exports` map is the contract jiffi-website-builder depends on. `verify-brand-exports.sh` in the website-builder checks these exact entries.
...
## Scope and access
`npm publish --access restricted` keeps it private to the jiffi-projects org. Team members with read access to the org can install it.
